...
function setEllItem(dom, type) {
    ...
    if (left - afterDomOffsetWidth - borderWidth < 0 && type === 'left')
        type = 'right';
    if (right + afterDomOffsetWidth + borderWidth > w && type === 'right')
        type = 'left';
    if (top - afterDomOffsetHeight - borderWidth < 0 && type === 'top')
        type = 'bottom';
    if (bottom + afterDomOffsetHeight + borderWidth > h && type === 'bottom')
        type = 'top';
